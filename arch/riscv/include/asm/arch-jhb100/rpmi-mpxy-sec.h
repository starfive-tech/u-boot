...
enum jhb100_firmware {
	...
	SET_INLINE_CRYPTO_CONFIG = 257,
	GET_PART_CRYPT_STATUS,
	SET_PART_CRYPT_STATUS,
	DICE_PROV_CERT0 = 513,
	DICE_UDS_REHASH,
	SET_SEC_MODE,
	KEY_PROV,
...
#define GET_BMCFW_INFO_EMMC_UFS_PARTITION_MASK	(GENMASK(2, 0))
#define GET_BMCFW_INFO_SFC_CS_NUM_MASK	(GENMASK(4, 3))
#define GET_BMCFW_INFO_SFC_CS_NUM_SHIFT	3
