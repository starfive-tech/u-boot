...
#define YT8512_EN_SLEEP_SW_BIT					BIT(15)
...
static int yt8531_startup(struct phy_device *phydev)
{
	...
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x000,
	// 		       0xFFFF, 0x1140);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x001,
	// 		       0xFFFF, 0x796D);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x002,
	// 		       0xFFFF, 0x4F51);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x003,
	// 		       0xFFFF, 0xE91A);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x004,
	// 		       0xFFFF, 0x1041);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x005,
	// 		       0xFFFF, 0x4DE1);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x006,
	// 		       0xFFFF, 0x0007);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x007,
	// 		       0xFFFF, 0x2801);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x008,
	// 		       0xFFFF, 0x0);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x009,
	// 		       0xFFFF, 0x0);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00A,
	// 		       0xFFFF, 0x0);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00B,
	// 		       0xFFFF, 0x0);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00C,
	// 		       0xFFFF, 0x0);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00D,
	// 		       0xFFFF, 0x0000);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00E,
	// 		       0xFFFF, 0x0000);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x00F,
	// 		       0xFFFF, 0x2000);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x010,
	// 		       0xFFFF, 0x0062);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x011,
	// 		       0xFFFF, 0x3C00);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x012,
	// 		       0xFFFF, 0x0000);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x013,
	// 		       0xFFFF, 0x7C21);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x014,
	// 		       0xFFFF, 0x082C);
	// ret = phy_modify(phydev, MDIO_DEVAD_NONE, 0x015,
	// 		       0xFFFF, 0x0000);

	// ret = ytphy_modify_ext(phydev, 0xA000,
	// 					0xFFFF, 0x0000);
	// ret = ytphy_modify_ext(phydev, 0xA001,
	// 		       0xFFFF, 0x8170);
	// ret = ytphy_modify_ext(phydev, 0xA003,
	// 		       0xFFFF, 0x0000);
	// ret = ytphy_modify_ext(phydev, 0xA004,
	// 		       0xFFFF, 0x3000);
	// ret = ytphy_modify_ext(phydev, 0xA005,
	// 		       0xFFFF, 0x00C0);
	// ret = ytphy_modify_ext(phydev, 0xA006,
	// 		       0xFFFF, 0x000D);
	// ret = ytphy_modify_ext(phydev, 0xA007,
	// 		       0xFFFF, 0x0000);
	// ret = ytphy_modify_ext(phydev, 0xA008,
	// 		       0xFFFF, 0x0000);
	// ret = ytphy_modify_ext(phydev, 0xA009,
	// 		       0xFFFF, 0x0000);
	// ret = ytphy_modify_ext(phydev, 0xA00A,
	// 		       0xFFFF, 0x0002);
	// ret = ytphy_modify_ext(phydev, 0xA010,
	// 		       0xFFFF, 0xDBFF);
	// ret = ytphy_modify_ext(phydev, 0xA012,
	// 		       0xFFFF, 0x00C8);

	// int read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0000);
	// printf("%s: %d  0x0000: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0001);
	// printf("%s: %d  0x0001: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0002);
	// printf("%s: %d  0x0002: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0003);
	// printf("%s: %d  0x0003: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0004);
	// printf("%s: %d  0x0004: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0005);
	// printf("%s: %d  0x0005: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0006);
	// printf("%s: %d  0x0006: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0007);
	// printf("%s: %d  0x0007: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0008);
	// printf("%s: %d  0x0008: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0009);
	// printf("%s: %d  0x0009: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000A);
	// printf("%s: %d  0x000A: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000B);
	// printf("%s: %d  0x000B: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000C);
	// printf("%s: %d  0x000C: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000D);
	// printf("%s: %d  0x000D: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000E);
	// printf("%s: %d  0x000E: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x000F);
	// printf("%s: %d  0x000F: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0010);
	// printf("%s: %d  0x0010: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0011);
	// printf("%s: %d  0x0011: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0012);
	// printf("%s: %d  0x0012: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0013);
	// printf("%s: %d  0x0013: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0014);
	// printf("%s: %d  0x0014: %x\n", __func__, __LINE__, read);
	// read = phy_read(phydev, MDIO_DEVAD_NONE, 0x0015);
	// printf("%s: %d  0x0015: %x\n\n", __func__, __LINE__, read);

	// read = ytphy_read_ext(phydev, 0xA000);
	// printf("%s: %d  0xA000: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA001);
	// printf("%s: %d  0xA001: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA003);
	// printf("%s: %d  0xA003: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA004);
	// printf("%s: %d  0xA004: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA005);
	// printf("%s: %d  0xA005: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA006);
	// printf("%s: %d  0xA006: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA007);
	// printf("%s: %d  0xA007: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA008);
	// printf("%s: %d  0xA008: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA009);
	// printf("%s: %d  0xA009: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA00A);
	// printf("%s: %d  0xA00A: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA010);
	// printf("%s: %d  0xA010: %x\n", __func__, __LINE__, read);
	// read = ytphy_read_ext(phydev, 0xA012);
	// printf("%s: %d  0xA012: %x\n", __func__, __LINE__, read);
...
static int yt8522_config_init(struct phy_device *phydev)
{
	...
	if (chip_mode == 0x2) { /* RMII2 mode */
		...
		if (ret < 0)
			return ret;
	} else if (chip_mode == 0x3) { /* RMII1 mode */
		val |= BIT(4);
		ret = ytphy_write_ext(phydev, YT8522_EXTENDED_COMBO_CTRL_1, val);
		if (ret < 0)
			return ret;
