...
static bool jhb100_bmcperiph1_is_i3cpad(u32 pin)
{
	return (pin >= JHB100_BMCPERIPH1_I3CPAD_PIN_START &&
		pin <= JHB100_BMCPERIPH1_I3CPAD_PIN_END);
}
...
static const struct jhb100_pinctrl_soc_info jhb100_bmcperiph1_pinctrl_info = {
	...
	.is_i3cpad			= jhb100_bmcperiph1_is_i3cpad,
};
