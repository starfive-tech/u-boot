...
/* Configurations descriptor parameters offsets in bytes*/
enum device_conf_param {
	CONF_DESC_LENGTH				= 0x00,
	CONF_DESC_DESCRIPTOR_IDN		= 0x01,
	CONF_DESC_CONF_DESC_CONTINUE	= 0x02,
	CONF_DESC_BOOT_ENABLE			= 0x03,
	CONF_DESC_DESCR_ACCESS_EN		= 0x04,
	CONF_DESC_INIT_POWER_MODE		= 0x05,
	CONF_DESC_HIGH_PRIORITY_LUN		= 0x06,
	CONF_DESC_SECURE_REMOVAL_TYPE	= 0x07,
	CONF_DESC_INIT_ACTIVE_ICC_LVL	= 0x08,
	CONF_DESC_PERIODIC_RTC_UPDATE	= 0x09,
	CONF_DESC_RESERVED				= 0x0B,
	CONF_DESC_RPMB_REGION_EN		= 0x0C,
	CONF_DESC_RPMB_REGION1_SIZE		= 0x0D,
	CONF_DESC_RPMB_REGION2_SIZE		= 0x0E,
	CONF_DESC_RPMB_REGION3_SIZE		= 0x0F

};

/* Geometry descriptor parameters offsets in bytes*/
enum ufs_geometry_desc_offsets {
	UFS_GEOMETRY_LENGTH						= 0x00,
	UFS_GEOMETRY_DESCRIPTOR_IDN				= 0x01,
	UFS_GEOMETRY_MEDIA_TECHNOLOGY			= 0x02,
	UFS_GEOMETRY_SERVED_03					= 0x03,
	UFS_GEOMETRY_TOTAL_RAW_DEVICE_CAPACITY	= 0x04,
	UFS_GEOMETRY_MAX_NUMBER_LU				= 0x0C,
	UFS_GEOMETRY_SEGMENT_SIZE				= 0x0D,
	UFS_GEOMETRY_ALLOCATION_UNIT_SIZE		= 0x11,
	UFS_GEOMETRY_MIN_ADDR_BLOCK_SIZE		= 0x12,
	UFS_GEOMETRY_OPTIMAL_READ_BLOCK_SIZE	= 0x13,
	UFS_GEOMETRY_OPTIMAL_WRITE_BLOCK_SIZE	= 0x14,
	UFS_GEOMETRY_MAX_IN_BUFFER_SIZE			= 0x15,
	UFS_GEOMETRY_MAX_OUT_BUFFER_SIZE		= 0x16,
	UFS_GEOMETRY_RPMB_READ_WRITE_SIZE		= 0x17,
	UFS_GEOMETRY_DYNAMIC_CAPACITY_RESOURCE_POLICY = 0x18,
	UFS_GEOMETRY_DATA_ORDERING				= 0x19,
	UFS_GEOMETRY_MAX_CONTEXT_ID_NUMBER		= 0x1A,
	UFS_GEOMETRY_SYS_DATA_TAG_UNIT_SIZE		= 0x1B,
	UFS_GEOMETRY_SYS_DATA_TAG_RES_SIZE		= 0x1C,
	UFS_GEOMETRY_SUPPORTED_SEC_R_TYPES		= 0x1D,
	UFS_GEOMETRY_SUPPORTED_MEMORY_TYPES		= 0x1E,
	UFS_GEOMETRY_SYSTEM_CODE_MAX_N_ALLOCU	= 0x20,
	UFS_GEOMETRY_SYSTEM_CODE_CAP_ADJ_FAC	= 0x24,
	UFS_GEOMETRY_NON_PERSIST_MAX_N_ALLOCU	= 0x26,
	UFS_GEOMETRY_NON_PERSIST_CAP_ADJ_FAC	= 0x2A,
	UFS_GEOMETRY_ENHANCED1_MAX_N_ALLOCU		= 0x2C,
	UFS_GEOMETRY_ENHANCED1_CAP_ADJ_FAC		= 0x30,
	UFS_GEOMETRY_ENHANCED2_MAX_N_ALLOCU		= 0x32,
	UFS_GEOMETRY_ENHANCED2_CAP_ADJ_FAC		= 0x36,
	UFS_GEOMETRY_ENHANCED3_MAX_N_ALLOCU		= 0x38,
	UFS_GEOMETRY_ENHANCED3_CAP_ADJ_FAC		= 0x3C,
	UFS_GEOMETRY_ENHANCED4_MAX_N_ALLOCU		= 0x3E,
	UFS_GEOMETRY_ENHANCED4_CAP_ADJ_FAC		= 0x42,
	UFS_GEOMETRY_OPTIMAL_LOGICAL_BLOCK_SIZE	= 0x44
};
