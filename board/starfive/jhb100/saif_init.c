...
void u0_dwc_ssi_spi_enable(void){
	SET_U0_BMCPERIPH1_IOMUX_FUNC0_SEL(1);
	SET_U0_BMCPERIPH1_IOMUX_FUNC1_SEL(1);
	SET_U0_BMCPERIPH1_IOMUX_FUNC2_SEL(1);
	SET_U0_BMCPERIPH1_IOMUX_FUNC3_SEL(1);
	SET_U0_BMCPERIPH1_IOMUX_FUNC4_SEL(1);

	_ENABLE_CLOCK_MAIN_ICG_EN_SPI0_;
	_ENABLE_CLOCK_CLK_U0_DWC_SSI_SPI_SSI_CLK_;
	_ENABLE_CLOCK_CLK_U0_DWC_SSI_SPI_HCLK_;
	_CLEAR_RESET_RSTGEN_MAIN_RSTN_SPI0_;
}
...
void u7_dwc_i2c_smbus_enable(void){
	SET_U0_BMCPERIPH0_GPIO_IOMUX_FUNC14_SEL(1);
	SET_U0_BMCPERIPH0_GPIO_IOMUX_FUNC15_SEL(1);

	_ENABLE_CLOCK_MAIN_ICG_EN_I2C7_;
	_ENABLE_CLOCK_CLK_GRP_100_APB_I2C_I2C7_;
	_ENABLE_CLOCK_CLK_GRP_100_APB_I2CF_I2CF7_;
	_ENABLE_CLOCK_CLK_CORE_I2C7_;
	_CLEAR_RESET_RSTGEN_MAIN_RSTN_I2C7_;

	// TODO: Disable filter controller in I2C7. This will be removed in the next phase.
	SET_U7_DWC_I2C_SMBUS__ITG_BD_APB_F__BASE_ADDR_SMBUS_FILTER_FILTER_CONTROL_SMBUS_FILTER_ENABLE(0);
}
